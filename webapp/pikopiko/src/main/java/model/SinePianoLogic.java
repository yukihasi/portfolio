...
public class SinePianoLogic extends Thread {
	private int count;
...
//	private Clip[] clip = new Clip[30];
	...
	public SinePianoLogic() {
		// TODO 自動生成されたコンストラクター・スタブ
		sineSound.setMsec(1000);
		sineSound.setSample_rate(44100f);
		sineSound.setVol(0.8);
	}

	 public void run() {
		 sineSound.createClip();
		 clip = sineSound.getClip();
